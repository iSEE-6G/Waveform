...
[taps,delay_taps,Doppler_taps,chan_coef] = channel_gen(Nsym,Nfft+Ncp+nPilots);
Rx = channel_output(Nsym,Nfft+Ncp+nPilots,taps,delay_taps,Doppler_taps,chan_coef,sigma_2,Tx);
